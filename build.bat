set llvmbindir=E:\llvm-9.0.1.src\build\Release\bin
set clangdir=C:\Program Files\LLVM\bin

Call "%clangdir%\clang++.exe" -cc1 -emit-llvm-bc -triple=wasm32-unknown-unknown-wasm -std=c++98 -Weverything -fvisibility hidden %cd%/pico_src/*.cpp %cd%/app/src/*.cpp
